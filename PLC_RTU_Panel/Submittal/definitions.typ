...
#let resub_comments = (
  "All panels (SCP, SPMP-01, SPMP-02, SFAN-01, UPS, and PLC) shall fit within the 11-ft backplate and comply with all applicable NFPA and NEC requirements. Final panel layout, dimensions, and code compliance remain the Contractor’s responsibility.": [A rudimentary drawing of the backplate with all of the provided panels laid out has been submitted for reference. The rest of this comment has been acknowledged.],
